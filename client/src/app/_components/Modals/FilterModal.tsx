...
const FilterModal = () => {
  ...
  if (!projectContext) {
    console.error("Filtering will not work, project context not initiated");
    return "Modal err...";
  }
            ...
            <Button
              ...
              onClick={(e) => {
                ...
                let branchParams = selectedBranches
                  ...
                  .join("");
                let majorParams = selectedMajors
                  .map((selectedMajor) => `&majors=${selectedMajor}`)
                  .join("");
                let filterQuery = `http://localhost:3500/projects?${
                  ...
                  instructor.length > 0
                    ? `&supervisors=${instructor[0].value}`
                    : ""
                }`;

                console.log("Filter query:", filterQuery);

                axios.get(filterQuery).then(
                  (response) => {
